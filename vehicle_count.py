...
# cap = cv2.VideoCapture('/Users/mohammedsohilshaikh/Downloads/WhatsApp Video 2022-03-18 at 2.41.22 PM.mp4')
...
classesFile = "yolo_v4/classes.txt"
...
## Model Files
modelConfiguration = 'yolo_v4/yolov4.cfg'
modelWeigheights = 'yolo_v4/yolov4.weights'

# configure the network model
net = cv2.dnn.readNetFromDarknet(modelConfiguration, modelWeigheights)
# net = cv2.dnn.readNet("yolo_v5/yolov5s.onnx")
...
def from_static_image(image, weight_dict, output_path):
    ...
    frequency = collections.Counter(postProcess(outputs, img))
    # print(frequency)
    # # Draw counting texts in the frame
    ...
    for key, value in dict(frequency).items():
        density += weight_dict[key] * value
    # cv2.putText(img, "Density: " + str(density), (20, 100))
    cv2.putText(img, "Density: " + str(density), (20, 100), cv2.FONT_HERSHEY_SIMPLEX, font_size,
                font_color, font_thickness)
...
if __name__ == '__main__':
    ...
    # # image_file = 'img_n_video/photo-1605602560252-2d23ec73d48a.jpeg'
    # image_file = cv2.imread('img_n_video/photo-1605602560252-2d23ec73d48a.jpeg')
    # print(from_static_image(image_file))
